...
public class MainActivity extends AppCompatActivity {
    ...
    private final Runnable mTestTask = new Runnable() {
        public void run() {
            ...
            //SmartJson Skipped because of much worse performance
            ...
            Log.v(TAG,"Thread Finished running inside onCreate");
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        writeToTextView("-----------------");
        Log.v(TAG,"Started -- before new Thread created for the Libraries");
